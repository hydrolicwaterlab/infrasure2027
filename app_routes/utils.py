...
FLASH = {
    ...
    # submissions
    "r1_created": ("success", "Abstract Round received — it is now pending review."),
    ...
    "round2_not_ready": ("error", "Selection Round opens once the reviewer selects your Abstract Round."),
    "format_chosen": ("success", "Format selected — now submit your Selection Round content."),
    "format_already_chosen": ("error", "The format is locked once Selection Round content is submitted."),
    "bad_format": ("error", "Please choose PPT or Poster."),
    "info_required": ("error", "Please complete your details before applying to present."),
    # Selection Round content (poster form / ppt PDF)
    "r2_content_saved": ("success", "Selection Round content saved — it is now pending Selection Round review."),
    "r2_uploaded": ("success", "PDF uploaded — it is now pending Selection Round review."),
    "r2_content_updated": ("success", "Selection Round content updated."),
    ...
    "need_content": ("error", "The student must submit Selection Round content before a reviewer can be assigned."),
    "content_locked": ("error", "Selection Round is under review or decided — content can no longer be changed."),
    # review (Abstract Round decision: Selected for the Selection Round / Not Selected)
    "r1_decision_saved": ("success", "Decision saved — the student can see the Abstract Round outcome."),
    "feedback_sent": ("success", "Feedback sent — the student can now choose their format for the Selection Round."),
    "not_your_theme": ("error", "You can only review submissions in your assigned themes."),
    "bad_decision": ("error", "Please choose Selected for the Selection Round or Not Selected."),
    # final decision (Selection Round: Selected / Not Selected)
    "final_decision_saved": ("success", "Final decision saved — the student can see the Selection Round outcome."),
    # admin phase controls
    "registration_closed": ("error", "Registration is currently closed — please try again later."),
    "round1_closed": ("error", "Abstract Round submissions are closed."),
    "round1_results_not_declared": ("error", "Abstract Round results are not announced yet."),
    "round2_closed": ("error", "Selection Round submissions are closed."),
    "round2_results_not_declared": ("error", "Selection Round results are not announced yet."),
    ...
    # reviewer workflow
    "assigned_reviewer": ("success", "Reviewer assigned — they can now review the Abstract Round."),
    ...
    "review_submitted": ("success", "Your decision was saved — the student can see the Abstract Round outcome."),
    ...
    "reviewer_removed": ("success", "Reviewer removed — review the Abstract Round yourself or assign a new reviewer."),
...
STATUS_LABELS = {
    ...
    "r1_selected": "Selected for the Selection Round",
    "r1_not_selected": "Not selected",
    "r2_pending": "Selection Round pending review",
    "r2_under_review": "Selection Round under review",
    "approved": "Approved",
    "rejected": "Rejected",
    # final decisions (Selection Round)
    "selected": "Selected",
